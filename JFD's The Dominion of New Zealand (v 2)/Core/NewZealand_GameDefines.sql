...
VALUES	('PROMOTION_JFD_ANZAC',					'TXT_KEY_PROMOTION_ANZAC',		'TXT_KEY_PROMOTION_ANZAC_HELP', 			'AS2D_IF_LEVELUP', 		10,								0,			0,			 0,			1,				59, 			'ABILITY_ATLAS', 					'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_ANZAC'),
		('PROMOTION_JFD_DEFENDER',				'TXT_KEY_PROMOTION_DEFENDER',	'TXT_KEY_PROMOTION_DEFENDER_HELP',			'AS2D_IF_LEVELUP', 		0,								0,			0,			 0,			1,				58, 			'ABILITY_ATLAS', 					'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_DEFENDER'),
		('PROMOTION_JFD_DEFENDER_ACTIVE',		'TXT_KEY_PROMOTION_DEFENDER',	'TXT_KEY_PROMOTION_DEFENDER_ACTIVE_HELP', 	'AS2D_IF_LEVELUP', 		0,								33,			33,			 1,			1,				0, 				'JFD_NEW_ZEALAND_PROMOTION_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_DEFENDER');
--==========================================================================================================================
-- UNITS
--==========================================================================================================================
-- Units
...
VALUES	('UNIT_JFD_ANZAC', 		'PROMOTION_JFD_ANZAC'),
		...
		('UNIT_JFD_DEFENDER', 	'PROMOTION_JFD_DEFENDER');
--==========================================================================================================================	
-- LEADERS
--==========================================================================================================================	
-- Leaders
...
VALUES	('LEADER_JFD_SEDDON', 		'TXT_KEY_LEADER_JFD_SEDDON', 	'TXT_KEY_LEADER_JFD_SEDDON_PEDIA', 	'TXT_KEY_CIVILOPEDIA_LEADERS_JFD_SEDDON', 	'Pouakai_Seddon_Scene.xml',		6, 						2, 						3, 							6, 			5, 				3, 				5, 						4, 				2, 			2, 			3, 				4, 			7, 			'JFD_NEW_ZEALAND_ATLAS', 	1);
--------------------------------		
...
SELECT	'CIVILIZATION_JFD_NEW_ZEALAND',	'TXT_KEY_CIV_JFD_NEW_ZEALAND_DESC',	'TXT_KEY_CIV_JFD_NEW_ZEALAND_SHORT_DESC',	'TXT_KEY_CIV_JFD_NEW_ZEALAND_ADJECTIVE',	'TXT_KEY_CIV5_JFD_NEW_ZEALAND_TEXT_1',  'TXT_KEY_CIV5_JFD_NEW_ZEALAND',	'PLAYERCOLOR_JFD_NEW_ZEALAND',	ArtDefineTag, ArtStyleType, ArtStyleSuffix, ArtStylePrefix, 'JFD_NEW_ZEALAND_ATLAS', 	0, 				'JFD_NEW_ZEALAND_ALPHA_ATLAS', 	'England',		'Pouakai_NewZealandMap_512.dds',	'TXT_KEY_CIV5_DAWN_NEW_ZEALAND_TEXT',	'Janboruta_NewZealand_DOM.dds'
...
VALUES  ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_1'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_2'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_3'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_4'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_5'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_6'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_7'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_8'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_9'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_10'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_11'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_12'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_13'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_14'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_15'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_16'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_17'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_18'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_19'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_20'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_21'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_22'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_23'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_24'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_25'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_26'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_27'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_28'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_29'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_30'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_31'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_32'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_33'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_34'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_35'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_36'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_37'),
        ('CIVILIZATION_JFD_NEW_ZEALAND',   'TXT_KEY_CITY_NAME_JFD_NEW_ZEALAND_38');
--------------------------------	
