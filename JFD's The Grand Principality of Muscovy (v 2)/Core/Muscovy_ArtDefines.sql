...
VALUES	('JFD_MUSCOVY_ATLAS', 						256, 		'JFD_MuscovyAtlas_256.dds',			4, 				1),
		...
		('JFD_MUSCOVY_PROMOTION_ATLAS', 			256, 	    'Tomatekh_PromotionAtlas_256.dds',	2, 				1),
		('JFD_MUSCOVY_PROMOTION_ATLAS', 			64, 	    'Tomatekh_PromotionAtlas_64.dds',	2, 				1),
		('JFD_MUSCOVY_PROMOTION_ATLAS', 			45, 	    'Tomatekh_PromotionAtlas_45.dds',	2, 				1),
		('JFD_MUSCOVY_PROMOTION_ATLAS', 			32, 	    'Tomatekh_PromotionAtlas_32.dds',	2, 				1),
...
VALUES	('SND_BUILDING_JFD_SOBOR',				'Sobor', 								'DynamicResident'),
		('SND_LEADER_MUSIC_JFD_IVAN_PEACE', 	'IvanIV_Peace', 						'DynamicResident'),
...
VALUES	('AS2D_BUILDING_JFD_SOBOR',				'SND_BUILDING_JFD_SOBOR',				'GAME_SFX', 		0.0,					100, 		100, 		0, 		 0),
		('AS2D_LEADER_MUSIC_JFD_IVAN_PEACE',	'SND_LEADER_MUSIC_JFD_IVAN_PEACE',		'GAME_MUSIC',		-1.0,					45, 		45, 		1, 		 0),
		('AS2D_LEADER_MUSIC_JFD_IVAN_WAR', 		'SND_LEADER_MUSIC_JFD_IVAN_WAR', 		'GAME_MUSIC',		-1.0,					45, 		45, 		1,		 0);
--==========================================================================================================================
-- ARTDEFINES
--==========================================================================================================================	
