...
-- CORE FUNCTIONS
--==========================================================================================================================
function JFD_Minoa_PlayerDoTurn(playerID)
	local player = Players[playerID]
	if (not player:IsAlive()) then return end
	if player:GetCivilizationType() ~= civilisationID then return end
	local rewardGoldenAgePoints = JFD_Minoa_GetGoldenAgePointsFromCoastalCities(playerID)
	player:ChangeGoldenAgeProgressMeter(rewardGoldenAgePoints)
end
GameEvents.PlayerDoTurn.Add(JFD_Minoa_PlayerDoTurn)
----------------------------------------------------------------------------------------------------------------------------
