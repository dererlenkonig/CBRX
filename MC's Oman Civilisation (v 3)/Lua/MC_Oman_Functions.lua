...
--------------------------------------------------------------
local civilisationID = GameInfoTypes["CIVILIZATION_MC_OMAN"]
...
if JFD_IsCivilisationActive(civilisationID) then
	print("Saif bin Sultan is in this game")
end
--------------------------------------------------------------------------------------------------------------------------
-- JFD_RemovePromotion
--------------------------------------------------------------------------------------------------------------------------
...
function UpdateGoldTopPanelInfo()
	...
	if player:GetCivilizationType() == GameInfoTypes["CIVILIZATION_MC_OMAN"] then	
...
function UpdatedGoldTipHandler( control )
	...
	local fTotalIncome = fGoldPerTurnFromCities + iGoldPerTurnFromOtherPlayers + fCityConnectionGold + iGoldPerTurnFromReligion + fTradeRouteGold + fTraitGold + goldFromDTRS;
			...
			for unit in player:Units() do
				if unit:GetUnitCombatType() == GameInfoTypes["UNITCOMBAT_NAVALRANGED"] or unit:GetUnitCombatType() == GameInfoTypes["UNITCOMBAT_NAVALMELEE"] then
					if goldPerTurn >= 40 then 
						JFD_AddPromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_40")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_30")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_20")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_10")
					elseif goldPerTurn >= 30 then 
						JFD_AddPromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_30")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_40")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_20")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_10")
					elseif goldPerTurn >= 20 then 
						JFD_AddPromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_20")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_40")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_30")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_10")
					elseif goldPerTurn >= 10 then 
						JFD_AddPromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_10")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_40")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_30")
						JFD_RemovePromotion(unit, "PROMOTION_JFD_MC_OMANI_BONUS_VS_CITIES_20")
					else
...
function JFD_BaghlahXP(playerID, unitID)
    ...
    if player:IsAlive() and player:GetCivilizationType() == GameInfoTypes["CIVILIZATION_MC_OMAN"] then 
			...
			if player:GetUnitByID(unitID):GetUnitType() == GameInfoTypes["UNIT_MC_OMANI_BAGHLAH"] and unit:IsHasPromotion(GameInfoTypes["PROMOTION_JFD_BAGHLAH"]) then
