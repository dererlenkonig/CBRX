...
VALUES		('CIVILIZATION_PAPUA',		'PACIFIC',		 'ANY'),
			('CIVILIZATION_PAPUA',		'MOD_TP_SOUTHEAST_ASIAN',	 'ANY');
...
SELECT		('CIVILIZATION_PAPUA'),				Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
INSERT INTO Civilizations_CordiformRequestedResource
			(Type, 										Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4)
SELECT		('CIVILIZATION_PAPUA'),				Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
FROM Civilizations_CordiformRequestedResource WHERE Type = 'CIVILIZATION_INDONESIA';
--==========================================================================================================================
