...
INSERT INTO Civilizations_YagemStartPosition
			(Type,										X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_TAUNGOO',						72,		43,		null,	null);
--==========================================================================================================================
...
INSERT INTO Civilizations_YahemStartPosition
			(Type,										X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_TAUNGOO',						98,		40,		null,	null);
--==========================================================================================================================
...
INSERT INTO Civilizations_CordiformStartPosition
			(Type,										X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_TAUNGOO',						62,		25,		null,	null);
--==========================================================================================================================
...
INSERT INTO Civilizations_GreatestEarthStartPosition
			(Type,										X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_TAUNGOO',						82,		38,		null,	null);
--==========================================================================================================================
...
SELECT		('CIVILIZATION_TAUNGOO');						('RESOURCE_GOLD'), "1", ('RESOURCE_HORSE'), "2", Req3, Yield3, Req4, Yield4
