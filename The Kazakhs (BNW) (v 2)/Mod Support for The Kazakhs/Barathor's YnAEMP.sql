...
INSERT INTO Civilizations_YagemStartPosition
			(Type,										X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_DJSH_KAZAKH',					54,		62,		null,	null);		
--==========================================================================================================================
...
INSERT INTO Civilizations_YahemStartPosition
			(Type,										X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_DJSH_KAZAKH',					83,		55,		null,	null);
--==========================================================================================================================
...
INSERT INTO Civilizations_CordiformStartPosition
			(Type,										X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_DJSH_KAZAKH',					56,		33,		null,	null);
--==========================================================================================================================
...
INSERT INTO Civilizations_GreatestEarthStartPosition
			(Type,										X,		Y,		AltX,	AltY)
VALUES		('CIVILIZATION_DJSH_KAZAKH',					75,		48,		null,	null);
--==========================================================================================================================
...
SELECT		('CIVILIZATION_DJSH_KAZAKH'),					Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
