...
VALUES		('CIVILIZATION_YUPIK',		'SLAVIC',		 'ANY'),
			('CIVILIZATION_YUPIK',		'FIRST_AMERICANS',	 'ANY');
...
SELECT		('CIVILIZATION_YUPIK'),				Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
INSERT INTO Civilizations_CordiformRequestedResource
			(Type, 										Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4)
SELECT		('CIVILIZATION_YUPIK'),				Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
FROM Civilizations_CordiformRequestedResource WHERE Type = 'CIVILIZATION_DENMARK';
--==========================================================================================================================
